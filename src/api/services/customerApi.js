...
export const customerAPI = {
  ...
  getCustomerDashboard: (customerId) =>
    api.get(`/customers/${customerId}/dashboard`),
  ...
  changePassword: (customerId, data) =>
    api.put(`/customers/${customerId}/password`, data),

  // Support
  createSupportTicket: (customerId, data) =>
    api.post(`/support/customer`, { customerId, ...data }),
