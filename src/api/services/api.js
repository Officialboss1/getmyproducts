...
export const usersAPI = {
  ...
  getSalesTeam: () => api.get('/users/team'),
};
...
export const salesAPI = {
  ...
  addSale: (saleData) => api.post('/sales', saleData),

  updateSale: (saleId, saleData) => api.put(`/sales/${saleId}`, saleData),
...
export const targetsAPI = {
  ...
  getDefaultTargets: () => api.get('/targets/default'),

  updateDefaultTargets: (targetData) => api.put('/targets/default', targetData),
};
...
export const auditAPI = {
  ...
  getAuditLogById: (logId) => api.get(`/audit/${logId}`),
...
export const referralsAPI = {
  ...
  getReferralProgress: () => api.get('/referrals/progress'),
  ...
  validateReferralCode: (code) => api.post('/referrals/validate', { code }), // MISSING ENDPOINT
};

// Teams APIs
export const teamsAPI = {
  getTeam: (teamId) => api.get(`/teams/${teamId}`), // MISSING ENDPOINT

  getTeamMembers: (teamId) => api.get(`/teams/${teamId}/members`), // MISSING ENDPOINT

  getMyTeam: () => api.get('/teams/my-team'), // MISSING ENDPOINT

  createTeam: (teamData) => api.post('/teams', teamData), // MISSING ENDPOINT

  updateTeam: (teamId, teamData) => api.put(`/teams/${teamId}`, teamData), // MISSING ENDPOINT

  getTeamPerformance: (teamId) => api.get(`/teams/${teamId}/performance`), // MISSING ENDPOINT
};

// Settings APIs
export const settingsAPI = {
  getSystemSettings: () => api.get('/settings'), // MISSING ENDPOINT

  updateSystemSettings: (settingsData) => api.put('/settings', settingsData), // MISSING ENDPOINT

  getReferralSettings: () => api.get('/settings/referral'), // MISSING ENDPOINT
